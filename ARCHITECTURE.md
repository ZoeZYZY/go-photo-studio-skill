...
- Pipeline writes run telemetry to `.pipeline-history/runs.ndjson`.
- Dashboard is generated by `skills/go-photo-studio/scripts/build-quality-dashboard.cjs`.
- Monitoring artifacts are generated into `skills/go-photo-studio/monitoring/`.
